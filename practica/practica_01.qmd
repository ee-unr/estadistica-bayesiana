...
1.  📌 **Sherlock**
    ...
    $(60 / 100) \cdot (1 / 100) + (1 / 100) \cdot (60 / 100) = 0.012$.
...
1.  💻 📌 **Puede fallar...**
    ...
    * $p$ es la probabilidad de falla
    ...
    probabilidad de éxito en vez de $\theta$.
...
1.  **¡Saludos a los cubos con puntos! (...) Serán dados**
    ...
    uno de los datos.
    Definir la distribución a priori no es complicado (es una distribución sobre $D_1$ y $D_2$).
