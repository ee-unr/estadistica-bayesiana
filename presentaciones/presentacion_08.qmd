...
La estructura jerárquica transmite mucha más información por la asociación fuerte de $\pi$ y $\omega$. Si los datos sugieren que $\pi=\frac{1}{3}$, eso también se vuelve evidencia fuerte de que $\omega$ debería estar más cerca de $\frac{1}{3}$.
