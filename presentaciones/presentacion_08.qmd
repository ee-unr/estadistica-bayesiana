...
Los datos dicen _la moneda parece tener $\pi$ cerca de 0.33_. El prior jerárquico dice _\pi debería estar alrededor de algún \omega, y antes de ver datos creíamos que \omega estaba cerca de 0.5_. Como la asociación es débil/moderada, $\pi$ se mueve hacia los datos, pero $\omega$ solo se mueve un poco hacia abajo.
...
La evidencia dice $\pi parece estar cerca de \frac{1}{3}$. Pero el _prior_ dice muy fuertemente $\omega está cerca de 0.5$. Como $\kappa$ no es grande, el modelo puede acomodar ambas cosas: permite que $\pi$ se aleje de $\omega$ sin tener que mover mucho a $\omega$.
