...
A esta altura, intentar usar `metropolis_hastings()` para muestrear del _posterior_ en los modelos
propuestos inicialmente resultaría muy dificultoso. Sería como pasar de manejar un Golcito por las
calles del pueblo a subirse a un Fórmula 1 en pleno Gran Premio.
...
### 2. _Free practice_: múltiples dimensiones, transformaciones y escala logarítmica
